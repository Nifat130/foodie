...
//
//     final getRestaurantsModel = getRestaurantsModelFromJson(jsonString);

import 'dart:convert';

GetRestaurantsModel getRestaurantsModelFromJson(String str) => GetRestaurantsModel.fromJson(json.decode(str));

String getRestaurantsModelToJson(GetRestaurantsModel data) => json.encode(data.toJson());

class GetRestaurantsModel {
  String? filterData;
  int? totalSize;
  String? limit;
  String? offset;
  ...
  factory GetRestaurantsModel.fromJson(Map<String, dynamic> json) => GetRestaurantsModel(
...
class Restaurant {
  ...
  ScheduleAdvanceDineInBookingDurationTimeFormat? scheduleAdvanceDineInBookingDurationTimeFormat;
